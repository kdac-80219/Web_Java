...
public class ReviewPojo {
	...
	public ReviewPojo( int moiveId, String review, int rating, int userId, String modifiedDate) {
		this.movieId = moiveId;
		this.review = review;
		this.rating = rating;
		this.userId = userId;
	...
	public ReviewPojo( int moiveId,int id,String review, int rating, int userId ) {
		this.movieId = moiveId;
		this.id=id;
		this.review = review;
		this.rating = rating;
